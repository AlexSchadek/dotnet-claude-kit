...
{
    [McpServerTool("get_public_api"), Description("Get the public members of a type without reading the full source file. Returns method signatures, properties, events.")]
